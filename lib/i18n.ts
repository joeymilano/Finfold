...
export const dashboardCopy = {
  zh: {
    ...
    unlockCopy: "解锁全文",
    unlockToExport: "解锁导出",
    lockedCtaPreview: "登录升级后查看完整转化动作和链接策略。",
    lockedNotesPreview: "登录升级后查看平台禁忌、发布时间和风控提醒。",
    copiedKit: "已复制整包",
    markdown: "导出 MD",
    trialReady: "免费预览已生成",
    trialDescription: "你可以先判断平台策略是否靠谱。复制全文、导出、保存历史和数据分析需要登录并升级。",
    body: "正文",
    cta: "CTA",
    notes: "注意事项",
    strategy: "平台策略",
  ...
  en: {
    ...
    copied: "Copied",
    copyAll: "Copy all",
    unlockToCopy: "Unlock copy",
    unlockCopy: "Unlock full copy",
    unlockToExport: "Unlock export",
    lockedCtaPreview: "Log in and upgrade to view the full conversion action and link strategy.",
    lockedNotesPreview: "Log in and upgrade to view platform caveats, timing, and risk notes.",
    copiedKit: "Copied kit",
    markdown: "Markdown",
    trialReady: "Free preview generated",
    trialDescription: "You can inspect the platform strategy first. Full copy, export, history, and analytics require login and upgrade.",
    body: "Body",
    cta: "CTA",
    notes: "Notes",
    strategy: "Strategy",
