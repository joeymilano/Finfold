...
export function OperatingDashboard() {
  ...
  const copy = locale === "en" ? {
    ...
    thisProduct: "本产品",
    benchmark: "同类基准",
    openWorkbench: "进入 Workbench",
    viewSchedule: "查看本周排期",
    dailyBrief: "今日运营简报",
    highPriorityCount: "3 个高优先级动作",
    agentCenter: "自动化指挥中心",
    agentSubtitle: "自动推进内容运营流程",
    agentDescription: "Agent 读取平台表现与资产缺口，自动创建生产任务、触发品牌质检、编排发布窗口，并把需要人工判断的事项送入审核队列。",
    openAgentCenter: "打开 Agent Center",
    automationEyebrow: "自动化流程",
    runningAutomation: "正在运行的自动化",
    platformEyebrow: "平台运营矩阵",
    platformTitle: "各平台运营状态",
    viewPackages: "查看资产包",
    coverageLabel: "平台覆盖率",
    readyLabel: "可发布",
    reviewLabel: "待审核",
